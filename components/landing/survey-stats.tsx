  ...
  return (
    <section className="bg-[#eef0ff] py-24">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <Reveal stagger={0.1} y={28} className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((s) => (
            <div
              key={s.label}
            ...
            >
              <div className="font-display text-5xl font-extrabold tracking-tight text-gradient">
                <CountUp to={s.value} suffix={s.suffix} decimals={Number.isInteger(s.value) ? 0 : 1} />
              </div>
